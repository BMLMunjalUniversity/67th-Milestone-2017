...
<div class="g-position--relative g-bg-color--dark">
    <div class="g-container--md g-padding-y-125--xs">
        ...
        if(isset($_GET['wp']) && $_GET['wp'] == 1) {
          ...
          echo "<p style='text-align:center' class='g-font-size-18--xs g-font-weight--500 g-color--white-opacity g-letter-spacing--2 g-margin-b-25--xs'>Registeration payment link:&nbsp;<a href='http://tinyurl.com/bmlfest'>http://tinyurl.com/bmlfest</a></p>";
        } else {
          ?>
